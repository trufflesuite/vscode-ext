...
This release has some fixes around internal optimizations for our Debug, removing some bugs from recovering data from built artifacts.
We also added some new features like an exclusive panel where you can view all logs generated by Truffle, Ganache and Dashabord
