...
declare module Nethereum {
  module Generators {
    ...
    module Core {
      ...
      export interface ClassGeneratorBase$2<TClassTemplate, TClassModel>
      ...
      export interface MessageMap$4TypeFunc<MFrom, MTo, PFrom, PTo> extends TypeFunction {
        ...
        new (
          from: MFrom,
          to: MTo,
          parameterMaps: System.Collections.Generic.List$1<ParameterMap$2<PFrom, PTo>>
      ...
      export interface MultipleClassGeneratorBase$2<TMultipleClassFileTemplate, TMultipleClassFileModel>
        extends System.Object,
          IFileGenerator,
          IGenerator {
        GenerateFileContent$1(outputPath: string): GeneratedFile;
      ...
      export interface MultipleClassGeneratorBase$2TypeFunc<TMultipleClassFileTemplate, TMultipleClassFileModel>
      ...
      export function MultipleClassGeneratorBase$2<TMultipleClassFileTemplate, TMultipleClassFileModel>(
        TMultipleClassFileTemplate: TypeArg<TMultipleClassFileTemplate>,
        TMultipleClassFileModel: TypeArg<TMultipleClassFileModel>
      ): MultipleClassGeneratorBase$2TypeFunc<TMultipleClassFileTemplate, TMultipleClassFileModel>;
      ...
      export interface ParameterMapperAssignerCSharpTemplate$4<
        TParameterModelFrom,
        TParameterModelTo,
        TParameterFrom,
        TParameterTo
      > extends ParameterMapperAssignerTemplate$4<
          TParameterModelFrom,
          TParameterModelTo,
          TParameterFrom,
          TParameterTo
      ...
      export interface ParameterMapperAssignerCSharpTemplate$4TypeFunc<
        ...
        TParameterTo
      > extends TypeFunction {
        (): ParameterMapperAssignerCSharpTemplate$4TypeFunc<
          TParameterModelFrom,
          TParameterModelTo,
          TParameterFrom,
          TParameterTo
      ...
      export function ParameterMapperAssignerCSharpTemplate$4<
        ...
        TParameterTo
      >(
        TParameterModelFrom: TypeArg<TParameterModelFrom>,
        TParameterModelTo: TypeArg<TParameterModelTo>,
        TParameterFrom: TypeArg<TParameterFrom>,
        TParameterTo: TypeArg<TParameterTo>
      ): ParameterMapperAssignerCSharpTemplate$4TypeFunc<
        TParameterModelFrom,
        TParameterModelTo,
        TParameterFrom,
      ...
      export interface ParameterMapperAssignerTemplate$4<
        TParameterModelFrom,
        TParameterModelTo,
        TParameterFrom,
        TParameterTo
      > extends System.Object {
        GenerateMappingAssigment$1(
      ...
      export interface ParameterMapperAssignerTemplate$4TypeFunc<
        ...
        TParameterTo
      > extends TypeFunction {
        (): ParameterMapperAssignerTemplate$4TypeFunc<
          TParameterModelFrom,
          TParameterModelTo,
          TParameterFrom,
          TParameterTo
      ...
      export interface ParameterMapperAssignerVbTemplate$4<
        TParameterModelFrom,
        TParameterModelTo,
        TParameterFrom,
        TParameterTo
      ...
      export interface ParameterMapperAssignerVbTemplate$4TypeFunc<
        ...
        TParameterTo
      > extends TypeFunction {
        (): ParameterMapperAssignerVbTemplate$4TypeFunc<
          TParameterModelFrom,
          TParameterModelTo,
          TParameterFrom,
          TParameterTo
      ...
      export interface WorkflowGeneratorBase$2<TWorkflowTemplate, TWorkflowModel>
        extends System.Object,
          IWorkflowFileGenerator,
          IWFGenerator,
          IWorkflowGenerator {
        GenerateFileContent$1(outputPath: string): GeneratedFile;
        GenerateFileContent(): string;
      ...
      export function WorkflowGeneratorBase$2<TWorkflowTemplate, TWorkflowModel>(
        TWorkflowTemplate: TypeArg<TWorkflowTemplate>,
        TWorkflowModel: TypeArg<TWorkflowModel>
      ): WorkflowGeneratorBase$2TypeFunc<TWorkflowTemplate, TWorkflowModel>;
    ...
    module Service {
      ...
      export interface AllMessagesGenerator
        extends Core.MultipleClassGeneratorBase$2<CQS.MultipleClassFileTemplate, AllMessagesModel>,
          Core.IFileGenerator,
          Core.IGenerator {
      ...
      export interface ServiceGenerator
        extends Core.ClassGeneratorBase$2<CQS.ClassTemplateBase$1<ServiceModel>, ServiceModel>,
          Core.IFileGenerator,
          Core.IGenerator,
    ...
    module CQS {
      ...
      export interface ContractDeploymentCQSMessageGenerator
        extends Core.ClassGeneratorBase$2<
            ClassTemplateBase$1<ContractDeploymentCQSMessageModel>,
      ...
      export interface ContractDeploymentCQSMessageModel
        extends Core.TypeMessageModel,
          Core.IClassModel,
          Core.IFileModel {
      ...
      export interface FunctionCQSMessageGenerator
        extends Core.ClassGeneratorBase$2<ClassTemplateBase$1<FunctionCQSMessageModel>, FunctionCQSMessageModel>,
          Core.IFileGenerator,
          Core.IGenerator,
          Core.IClassGenerator {
        get_FunctionABI(): Model.FunctionABI;
      ...
      export interface ContractDeploymentCQSMessageCSharpTemplate
      ...
      export interface FunctionCQSMessageCSharpTemplate
      ...
      export interface ContractDeploymentCQSMessageVbTemplate
        extends ClassTemplateBase$1<ContractDeploymentCQSMessageModel>,
          Core.IClassTemplate {
        GetPartialMainClass(): string;
      }
      ...
      export interface FunctionCQSMessageVbTemplate
        extends ClassTemplateBase$1<FunctionCQSMessageModel>,
          Core.IClassTemplate {
        GetPartialMainClass(): string;
      }
    ...
    module DataWorkflow {
      ...
      export interface DataWorkflowEventSqlModel
        extends Core.WorkflowTypeMessageModel,
          Core.IWorkflowModel,
          Core.IFileModel {
      ...
      export interface DataWorkflowSqlOutputGenerator
        extends Core.WorkflowGeneratorBase$2<
            Core.WorkflowTemplateBase$1<DataWorkflowEventSqlModel>,
      ...
      export interface DataWorkflowEventLogicAppModel
        extends Core.WorkflowTypeMessageModel,
          Core.IWorkflowModel,
          Core.IFileModel {
        get_EventABI(): Model.EventABI;
      ...
      export interface DataWorkflowFunctionOutputLogicAppGenerator
        extends Core.WorkflowGeneratorBase$2<
            Core.WorkflowTemplateBase$1<DataWorkflowEventLogicAppModel>,
      ...
      module LogicApps {
        ...
        export interface DataWorkflowFunctionOutputLogicAppTemplate
      ...
      module FlowApps {
        ...
        export interface DataWorkflowFunctionOutputFlowAppGenerator
          extends Core.WorkflowGeneratorBase$2<
              Core.WorkflowTemplateBase$1<DataWorkflowEventFlowAppModel>,
        ...
        export interface DataWorkflowFunctionOutputFlowAppTemplate
    ...
    module DTOs {
      ...
      export interface EventDTOGenerator
        extends Core.ClassGeneratorBase$2<CQS.ClassTemplateBase$1<EventDTOModel>, EventDTOModel>,
          Core.IFileGenerator,
          Core.IGenerator,
          Core.IClassGenerator {
        InitialiseTemplate(codeGenLanguage: Core.CodeGenLanguage): void;
      ...
      export interface FunctionOutputDTOGenerator
        extends Core.ClassGeneratorBase$2<CQS.ClassTemplateBase$1<FunctionOutputDTOModel>, FunctionOutputDTOModel>,
          Core.IFileGenerator,
          Core.IGenerator,
          Core.IClassGenerator {
        InitialiseTemplate(codeGenLanguage: Core.CodeGenLanguage): void;
      ...
      export interface FunctionOutputDTOCSharpTemplate
      ...
      export interface FunctionOutputDTOVbTemplate
        extends CQS.ClassTemplateBase$1<FunctionOutputDTOModel>,
          Core.IClassTemplate {
        GetPartialMainClass(): string;
      }
    ...
    module MessagingWorkflow {
      ...
      module FlowApps {
        ...
        export interface MessagingWorkflowEventFlowAppGenerator
          extends Core.WorkflowGeneratorBase$2<
              Core.WorkflowTemplateBase$1<MessagingWorkflowEventFlowAppModel>,
        ...
        export interface MessagingWorkflowEventFlowAppModel
          extends Core.WorkflowTypeMessageModel,
            Core.IWorkflowModel,
            Core.IFileModel {
          get_EventABI(): Model.EventABI;
        ...
        export interface MessagingWorkflowEventFlowAppTemplate
      ...
      module LogicApps {
        ...
        export interface MessagingWorkflowEventLogicAppGenerator
          extends Core.WorkflowGeneratorBase$2<
              Core.WorkflowTemplateBase$1<MessagingWorkflowEventLogicAppModel>,
        ...
        export interface MessagingWorkflowEventLogicAppModel
          extends Core.WorkflowTypeMessageModel,
            Core.IWorkflowModel,
            Core.IFileModel {
          get_EventABI(): Model.EventABI;
        ...
        export interface MessagingWorkflowEventLogicAppTemplate
    ...
    module ReportingWorkflow {
      ...
      export interface ReportingWorkflowCSharpOutputLogicAppGenerator
        extends Core.WorkflowGeneratorBase$2<
            Core.WorkflowTemplateBase$1<ReportingWorkflowEventCSharpLogicAppModel>,
      ...
      export interface ReportingWorkflowEventCSharpLogicAppModel
        extends Core.WorkflowTypeMessageModel,
          Core.IWorkflowModel,
          Core.IFileModel {
        get_EventABI(): Model.EventABI;
      ...
      export interface ReportingWorkflowEventsOutputLogicAppGenerator
        extends Core.WorkflowGeneratorBase$2<
            Core.WorkflowTemplateBase$1<ReportingWorkflowEventLogicAppModel>,
      ...
      export interface ReportingWorkflowGenerator
        extends Core.WorkflowGeneratorBase$2<
            Core.WorkflowTemplateBase$1<ReportingWorkflowModel>,
            ReportingWorkflowModel
          >,
          Core.IWorkflowFileGenerator,
          Core.IWFGenerator,
          Core.IWorkflowGenerator {
      ...
      export interface ReportingWorkflowModel
        extends Core.WorkflowTypeMessageModel,
          Core.IWorkflowModel,
          Core.IFileModel {
        get_ContractABI(): Model.ContractABI;
      ...
      export interface ReportingWorkflowTemplate
        extends Core.WorkflowTemplateBase$1<ReportingWorkflowModel>,
          Core.IWorkflowTemplate {}
      ...
      module LogicApps {
        ...
        export interface ReportingWorkflowEventsOutputLogicAppTemplate
    ...
    module ServiceWorkflow {
      ...
      module FlowApps {
        ...
        export interface ServiceWorkflowFunctionOutputFlowAppGenerator
          extends Core.WorkflowGeneratorBase$2<
              Core.WorkflowTemplateBase$1<ServiceWorkflowFunctionOutputFlowAppModel>,
        ...
        export interface ServiceWorkflowFunctionOutputFlowAppModel
          extends Core.WorkflowTypeMessageModel,
            Core.IWorkflowModel,
            Core.IFileModel {
          get_FunctionABI(): Model.FunctionABI;
        ...
        export interface ServiceWorkflowFunctionOutputFlowAppTemplate
      ...
      module Function {
        ...
        export interface ServiceWorkflowFunctionOutputFunctionGenerator
          extends Core.WorkflowGeneratorBase$2<
              Core.WorkflowTemplateBase$1<ServiceWorkflowFunctionOutputFunctionModel>,
        ...
        export interface ServiceWorkflowFunctionOutputFunctionModel
          extends Core.WorkflowTypeMessageModel,
            Core.IWorkflowModel,
            Core.IFileModel {
          get_FunctionABI(): Model.FunctionABI;
        ...
        module Blockchain {
          ...
          export interface ServiceWorkflowFunctionOutputBlockchainFileGenerator
            extends Core.WorkflowGeneratorBase$2<
                Core.WorkflowTemplateBase$1<ServiceWorkflowFunctionOutputBlockchainFileModel>,
          ...
          export interface ServiceWorkflowFunctionOutputBlockchainFileModel
            extends Core.WorkflowTypeMessageModel,
              Core.IWorkflowModel,
              Core.IFileModel {
        ...
        module CSProj {
          ...
          export interface ServiceWorkflowFunctionOutputCSProjGenerator
            extends Core.WorkflowGeneratorBase$2<
                Core.WorkflowTemplateBase$1<ServiceWorkflowFunctionOutputCSProjModel>,
                ServiceWorkflowFunctionOutputCSProjModel
              >,
              Core.IWorkflowFileGenerator,
              Core.IWFGenerator,
              Core.IWorkflowGenerator {}
          ...
          export interface ServiceWorkflowFunctionOutputCSProjModel
            extends Core.WorkflowTypeMessageModel,
              Core.IWorkflowModel,
              Core.IFileModel {
        ...
        module Host {
          ...
          export interface ServiceWorkflowFunctionOutputHostFileGenerator
            extends Core.WorkflowGeneratorBase$2<
                Core.WorkflowTemplateBase$1<ServiceWorkflowFunctionOutputHostFileModel>,
                ServiceWorkflowFunctionOutputHostFileModel
              >,
              Core.IWorkflowFileGenerator,
              Core.IWFGenerator,
              Core.IWorkflowGenerator {}
          ...
          export interface ServiceWorkflowFunctionOutputHostFileModel
            extends Core.WorkflowTypeMessageModel,
              Core.IWorkflowModel,
              Core.IFileModel {
            CanGenerateFile(): boolean;
      ...
      module LogicApps {
        ...
        export interface ServiceWorkflowFunctionOutputLogicAppGenerator
          extends Core.WorkflowGeneratorBase$2<
              Core.WorkflowTemplateBase$1<ServiceWorkflowFunctionOutputLogicAppModel>,
        ...
        export interface ServiceWorkflowFunctionOutputLogicAppModel
          extends Core.WorkflowTypeMessageModel,
            Core.IWorkflowModel,
            Core.IFileModel {
          get_FunctionABI(): Model.FunctionABI;
        ...
        export interface ServiceWorkflowFunctionOutputLogicAppTemplate
    ...
    module XUnit {
      ...
      export interface SimpleTestGenerator
        extends Core.ClassGeneratorBase$2<CQS.ClassTemplateBase$1<SimpleTestModel>, SimpleTestModel>,
          Core.IFileGenerator,
          Core.IGenerator,
          Core.IClassGenerator {
        get_ContractABI(): Model.ContractABI;
